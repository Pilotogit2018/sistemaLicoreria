...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Licoreria "El Tabernero"</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/inicio/index" class="nav-link">
              <i class="nav-icon fas fa-calendar-alt"></i><!--CAMBIAR ICONO-->
              <p>
                Inicio
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="pages/gallery.html" class="nav-link">
              <i class="nav-icon far fa-image"></i><!--CAMBIAR ICONO-->
              <p>
                productos
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/categoria/index" class="nav-link">
              <i class="nav-icon fas fa-calendar-alt"></i><!--CAMBIAR ICONO-->
              <p>
                Categorias
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/proveedor/lista" class="nav-link">
              <i class="nav-icon fas fa-calendar-alt"></i><!--CAMBIAR ICONO-->
              <p>
                proveedores
              </p>
